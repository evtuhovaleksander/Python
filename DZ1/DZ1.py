...
# Далее вы случайным образом (модуль random) разбиваете команды по парам и формируете сетку плей-офф - думаю все знают,
#  как проводятся такие турниры (1/8-я, 1/4-я, полуфиналы и финал). Далее проводите матчи - счет определяется случайным образом.
# По окончании турнира нужно иметь возможность запросить и посмотреть как выступила в турнире та или иная команда -
# с кем на какой стадии играла, счет матча. Если что-то непонятно по условию - спросите и я уточню.
